...
export class Flughafenergebnis {
     ...
     * @param flughafen Name/Stadt Flughafen, z.B. "Frankfurt a.M." für IATA-Code "FRA";
     *                  muss für `gefunden=false` leer sein.
     * @param land      Land, in dem sich `flughafen` befindet, z.B. `Deutschland` für IATA-Code "FRA";
     *                  muss für `gefunden=false` leer sein.
     */
